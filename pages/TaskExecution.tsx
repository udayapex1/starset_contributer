  ...
  if (step === 'brief') {
    return (
      <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
        <button onClick={onBack} className="flex items-center text-sm font-medium text-stone-500 hover:text-stone-900 dark:hover:text-white mb-6 transition-colors">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-stone-200 dark:border-white/10 shadow-xl shadow-stone-200/50 dark:shadow-none overflow-hidden">
          <div className="px-6 md:px-10 py-6 md:py-8 border-b border-stone-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center bg-[#FAF9F7] dark:bg-white/5 gap-4">
            <div>
               <h2 className="text-2xl md:text-3xl font-bold text-[#121212] dark:text-white leading-tight">{task.title}</h2>
               <div className="flex flex-wrap items-center mt-3 gap-3 md:gap-4 text-sm text-stone-500">
            ...
            <div className="flex items-center md:block w-full md:w-auto justify-between md:text-right border-t md:border-t-0 border-stone-200 dark:border-white/10 pt-4 md:pt-0">
              ...
              <div className="text-2xl md:text-3xl font-bold text-[#0f766e] dark:text-emerald-400">₹{task.compensation.toFixed(2)}</div>
            </div>
          </div>
          ...
          <div className="p-6 md:p-10 space-y-8 md:space-y-10">
             ...
             <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                <div className="p-4 md:p-6 bg-blue-50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-900/20">
                ...
                <div className="p-4 md:p-6 bg-purple-50 dark:bg-purple-900/10 rounded-xl border border-purple-100 dark:border-purple-900/20">
            ...
            <div className="prose prose-stone dark:prose-invert max-w-none">
              <h3 className="text-lg md:text-xl font-bold text-[#121212] dark:text-white mb-4">Operational Instructions</h3>
              <p className="text-stone-600 dark:text-stone-300 leading-relaxed bg-[#FAF9F7] dark:bg-white/5 p-6 md:p-8 rounded-2xl border border-stone-100 dark:border-white/5 font-mono text-sm">{task.instructions}</p>
            </div>
            
            <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/20 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row gap-5">
              ...
              <div className="text-amber-900 dark:text-amber-200">
                <p className="font-bold text-lg mb-2">Quality Standards</p>
            ...
            <div className="flex justify-end pt-8 border-t border-stone-100 dark:border-white/10">
              <Button size="lg" onClick={() => setStep('consent')} className="w-full md:w-auto px-10 h-14 text-lg">Proceed to Consent <ArrowLeft className="ml-2 h-5 w-5 rotate-180" /></Button>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="max-w-7xl mx-auto animate-in fade-in duration-500">
       <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-stone-200 dark:border-white/10 shadow-2xl shadow-stone-200/50 dark:shadow-none overflow-hidden flex flex-col md:flex-row min-h-[600px]">
         ...
         {/* Main Execution Area */}
         <div className="flex-1 p-6 md:p-16 flex flex-col items-center justify-center relative bg-white dark:bg-zinc-900 order-2 md:order-2">
            ...
            {task.type === TaskType.AUDIO_COLLECTION && (
              <>
                 ...
                 <div className="w-full max-w-2xl mx-auto text-center space-y-12 md:space-y-16 mt-12 md:mt-0">
                   <div className="space-y-6">
                     ...
                     <p className="text-2xl md:text-5xl font-serif text-[#121212] dark:text-white leading-tight px-2">
                       "{task.prompt}"
                     </p>
                   </div>
                       ...
                       <div className="w-full animate-in slide-in-from-bottom-4 fade-in duration-500">
                         <div className="bg-[#FAF9F7] dark:bg-white/5 rounded-2xl p-4 md:p-6 border border-stone-200 dark:border-white/10 mb-8 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              <button className="h-10 w-10 md:h-12 md:w-12 rounded-full bg-white dark:bg-black border border-stone-200 dark:border-white/10 flex items-center justify-center text-stone-700 dark:text-stone-300 hover:text-[#0f766e] dark:hover:text-teal-400 hover:border-[#0f766e] dark:hover:border-teal-400 transition-colors shadow-sm">
