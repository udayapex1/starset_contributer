...
export const LandingPage: React.FC<LandingPageProps> = ({ onEnterApp, onStartSignup, isDark, toggleTheme, onNavigate }) => {
  ...
  return (
    <PublicLayout currentPage="home" onNavigate={onNavigate} onEnterApp={onEnterApp} isDark={isDark} toggleTheme={toggleTheme}>
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative z-10 pt-24 md:pt-32 pb-12 md:pb-24 px-4 md:px-6 overflow-hidden perspective-1000">
            ...
            <div className="flex gap-6 animate-marquee whitespace-nowrap">
                {[...Array(10)].map((_, i) => (
                   <div key={i} className="flex items-center gap-3 bg-white/5 border border-white/5 rounded-full pl-2 pr-6 py-2 backdrop-blur-sm hover:bg-white/10 transition-colors cursor-default">
                      <div className={`h-10 w-10 rounded-full flex items-center justify-center font-bold text-xs text-white shadow-lg bg-gradient-to-br ${
                          ['from-purple-500 to-indigo-600', 'from-blue-500 to-cyan-500', 'from-emerald-500 to-teal-600', 'from-orange-500 to-red-500', 'from-pink-500 to-rose-500'][i % 5]
                      }`}>
                         {['MK', 'JD', 'AS', 'TR', 'PL'][i % 5]}
                      </div>
